...
/**
 * Calculates projected potentials with the random atom displacements restricted to a certain range.
 * Is not multithreaded, because this will run in a thread.
 * Does not implement partial occupancy...
*/
